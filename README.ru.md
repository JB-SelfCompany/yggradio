...
YggRadio — это децентрализованная платформа потокового радиовещания, построенная на базе сети Yggdrasil. Она предоставляет самостоятельно размещаемое решение с приоритетом конфиденциальности для вещания и прослушивания радиопотоков через зашифрованную mesh-сеть. Без необходимости в центральных серверах, YggRadio обеспечивает истинное peer-to-peer радиовещание со сквозным шифрованием, предоставляемым транспортным уровнем TLS 1.3 сети Yggdrasil.

Платформа поддерживает множество аудиоформатов, предлагает двойную систему аутентификации (криптографические подписи Ed25519 или magic links) и включает опциональную систему федерации для обнаружения станций в сети. Весь трафик автоматически шифруется, и система не требует личной информации от пользователей.
